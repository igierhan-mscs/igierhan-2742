...
public class DbContext {
    ...
    public static ArrayList<Person> getPeople() {
        ...
        people.add(new Person(101, "Steve", "Smith", "Steve.Smith"));
        people.add(new Person(102, "John", "Martin", "John.Martin"));
        people.add(new Person(103, "David", "Thomas", "Steve.Smith"));
        people.add(new Person(104, "Michael", "Robertson", "John.Martin"));
        people.add(new Person(105, "Sarah", "Foster", "Steve.Smith"));
