...
public class Person {
    ...
    public void setLastName(String lastName) {
        if (lastName != null && lastName.length() >= 2 && lastName.length() <= 30)
            ...
            throw new PersonIllegalArgumentException(lastName + " is invalid. Last name must be between 2 and 30 characters");
    }
    ...
    public void setUserName(String userName){
        if (userName!= null && userName.length() >= 5 && userName.length() <= 30) {
            ...
            throw new PersonIllegalArgumentException(userName + " is invalid. User name must be between 5 and 30 characters");
    }
